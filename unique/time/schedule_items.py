...
SleepOver: _Verb = ALL.verb("SleepOver", NPCHandle, "sleepover with {arg}", DestinationRule.Follow)
GoToWork: _Verb = ALL.verb("GoToWork", EnterpriseHandle, "work at {arg}", DestinationRule.Follow)
